...
\item Rajouter ou modifier la documentation : Quand les ADSI passent en mode édition et en appuyant sur un composant de la page web, la modale qui s'affiche permet de rajouter ou modifier une étape du Bootstrap Tour de cette page.\\

 
\underline{Mise en oeuvre} : \\

- En appuyant sur un composant de la page, nous envoyons une requête Ajax au Web service AppTour pour récupérer l'étape dans le cas où elle existe. Nous passons en paramètre l'Id du l'élément appuyer ainsi que id du tour de la page web où il se trouve l'ADSI. 
